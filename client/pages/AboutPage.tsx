          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div className="bg-gradient-to-br from-primary-50 to-white p-8 rounded-2xl shadow-lg border border-primary-100">
              ...
              <p className="text-brand-gray leading-relaxed">
                To empower businesses worldwide with cutting-edge payment solutions that simplify 
                financial transactions, enhance security, and drive growth. We believe that every 
                business, regardless of size, deserves access to enterprise-grade payment infrastructure.
              </p>
            </div>
            <div className="bg-gradient-to-br from-brand-teal/10 to-white p-8 rounded-2xl shadow-lg border border-brand-teal/20">
              ...
              <p className="text-brand-gray leading-relaxed">
                To become the global leader in financial technology, creating a world where payments 
                are instant, secure, and effortless. We envision a future where geographical boundaries 
                don't limit business growth and where every transaction contributes to economic prosperity.
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center mb-16">
            ...
            <p className="text-lg leading-8 text-brand-gray">
              We combine innovative technology with unmatched reliability to deliver superior payment experiences
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-brand-navy mb-2">99.9% Uptime Guarantee</h4>
                  <p className="text-brand-gray">Reliable service with minimal downtime, ensuring your business never misses a payment.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <CheckCircle className="h-6 w-6 text-brand-teal mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-brand-navy mb-2">Global Reach</h4>
                  <p className="text-brand-gray">Accept payments from 190+ countries with multi-currency support and localized payment methods.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <CheckCircle className="h-6 w-6 text-brand-teal mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-brand-navy mb-2">24/7 Customer Support</h4>
                  <p className="text-brand-gray">Round-the-clock assistance from our expert support team whenever you need help.</p>
                </div>
              </div>
            </div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <CheckCircle className="h-6 w-6 text-brand-teal mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-brand-navy mb-2">Developer-Friendly APIs</h4>
                  <p className="text-brand-gray">Comprehensive APIs and SDKs with detailed documentation for seamless integration.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <CheckCircle className="h-6 w-6 text-brand-teal mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-brand-navy mb-2">Competitive Pricing</h4>
                  <p className="text-brand-gray">Transparent pricing with no hidden fees, designed to scale with your business growth.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <CheckCircle className="h-6 w-6 text-brand-teal mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-brand-navy mb-2">Enterprise Security</h4>
                  <p className="text-brand-gray">Bank-grade encryption and compliance with global financial regulations.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          ...
          <p className="text-lg leading-8 text-brand-gray mb-8">
            Ready to transform your payment infrastructure? Contact us today to learn more about DekainPay solutions.
          </p>
