...
export default function Features() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Our automated dispute management system streamlines the entire process from initial notification to resolution. We provide comprehensive documentation, evidence collection tools, and work directly with card networks to resolve disputes efficiently."
    },
    {
      question: "Is there a minimum transaction volume requirement?",
      answer: "No, DekainPay serves businesses of all sizes, from startups to enterprise corporations. Our scalable infrastructure grows with your business without minimum volume requirements or setup fees for small businesses."
    }
  ];
